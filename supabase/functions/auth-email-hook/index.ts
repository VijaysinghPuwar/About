...
// Configuration
const SITE_NAME = "vijaysinghpuwar"
const SENDER_DOMAIN = "notify.vijaysinghpuwar.com"
const ROOT_DOMAIN = "vijaysinghpuwar.com"
const FROM_DOMAIN = "vijaysinghpuwar.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://vijaysinghpuwar.lovable.app"
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  interface HookPayload {
    ...
    version?: string
    type?: string
    data: { action_type: string; email: string; url: string; [key: string]: unknown }
  }
